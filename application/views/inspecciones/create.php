<section class="pb_cover_v3 overflow-hidden cover-bg-indigo cover-bg-opacity text-left pb_gradient_v1 pb_slant-light" id="section-home">
    <div class="map_container">
      ...
      <div id="locationCopied">
        ...
        <div class="mb-4 backbutton"><a class="btn btn-primary btn-lg btn-block pb_btn-pill  btn-shadow-blue">Seleccionar</a></div>
      </div>
      <div id="wrapper">
    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
          <div id="crear-inspec">
            <h2 class="heading mb-3">Nueva Inspección</h2>
            <div class="sub-heading">
              <p class="mb-4">Ingrese los datos de la inspección</p>
            </div>
          </div>
          <div class="col-md-1">
          </div>
          <div class="col-md-6 relative align-self-center" id="form-inspec">
            ...
            <?php echo form_open('inspecciones/create', 'class="bg-white rounded pb_form_v1"'); ?>
              ...
              <div class="form-group">
                  <label for="bombero">Bombero a quien se le asigna la inspección</label>
              ...
              <div class="form-group">
                  <label for="bombero">Hidrante al que se realiza la inspección</label>
                <div class="pb_select-wrap">
              ...
              <div class="form-group localizacion">
                <label for="bombero">Diríjase al mapa y haga click sobre la ubicación del nuevo hidrante para copiarla</label>
                <div class="form-group">
